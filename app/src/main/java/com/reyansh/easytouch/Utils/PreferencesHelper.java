package com.reyansh.easytouch.Utils;
...
public class PreferencesHelper {
    ...
    private static final String EASY_TOUCH_PREFERENCE = "EASY_TOUCH_PREFERENCES";
    ...
    private PreferencesHelper(Context context) {
        mPref = context.getSharedPreferences(EASY_TOUCH_PREFERENCE, Context.MODE_PRIVATE);
    }
